  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12 {{ $fish->video !== null ? 'col-md-6': ''}} mb-3">
        ...
        <div class="col-12 col-md-6 mb-3">
          <iframe class="showVideo mt-3"  src="{{ 'https://www.youtube.com/embed/'.$fish->video }}" frameborder="0" allowfullscreen></iframe>
        </div>
        @endif
        ...
        <div class="mt-3">
          <a href="{{url('fish')}}" class="btn btn-success mr-4"><span data-feather="arrow-left"></span> Kembali </a>
